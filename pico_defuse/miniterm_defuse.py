...
MAGIC_UPLD = [0x55, 0xaa, 0x55, 0xaa, 0x55, 0xaa, 0x55, 0xaa, 0x55, 0x50, 0x4C, 0x44]
...
class Miniterm(object):
    ...
    def upload_file_by_name(self, filename):
        try:
            with open(filename, 'rb') as f:
                ...
                sys.stderr.write('--- ' + hex(fsize) + ' ---\n')
                self.serial.write(bytes([0x55, 0xaa, 0x55, 0xaa, 0x55, 0xaa, 0x55, 0xaa]))
                self.serial.write(struct.pack(">L", fsize))
                ...
                while True:
                    ...
                    self.serial.flush()
                    sys.stderr.write(hex(sent_bytes) + '...\r')   # Progress indicator.
    ...
    def upload_file(self):
        ...
        with self.console:
            ...
            if filename:
                self.upload_file_by_name(filename)
